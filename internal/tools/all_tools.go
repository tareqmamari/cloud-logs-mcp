...
func NewGetRuleGroupTool(c *client.Client, l *zap.Logger) *GetRuleGroupTool { return &GetRuleGroupTool{NewBaseTool(c, l)} }
...
func NewListRuleGroupsTool(c *client.Client, l *zap.Logger) *ListRuleGroupsTool { return &ListRuleGroupsTool{NewBaseTool(c, l)} }
...
func NewCreateRuleGroupTool(c *client.Client, l *zap.Logger) *CreateRuleGroupTool { return &CreateRuleGroupTool{NewBaseTool(c, l)} }
...
func NewUpdateRuleGroupTool(c *client.Client, l *zap.Logger) *UpdateRuleGroupTool { return &UpdateRuleGroupTool{NewBaseTool(c, l)} }
...
func NewDeleteRuleGroupTool(c *client.Client, l *zap.Logger) *DeleteRuleGroupTool { return &DeleteRuleGroupTool{NewBaseTool(c, l)} }
...
func NewGetOutgoingWebhookTool(c *client.Client, l *zap.Logger) *GetOutgoingWebhookTool { return &GetOutgoingWebhookTool{NewBaseTool(c, l)} }
...
func NewListOutgoingWebhooksTool(c *client.Client, l *zap.Logger) *ListOutgoingWebhooksTool { return &ListOutgoingWebhooksTool{NewBaseTool(c, l)} }
...
func NewCreateOutgoingWebhookTool(c *client.Client, l *zap.Logger) *CreateOutgoingWebhookTool { return &CreateOutgoingWebhookTool{NewBaseTool(c, l)} }
...
func NewUpdateOutgoingWebhookTool(c *client.Client, l *zap.Logger) *UpdateOutgoingWebhookTool { return &UpdateOutgoingWebhookTool{NewBaseTool(c, l)} }
...
func NewDeleteOutgoingWebhookTool(c *client.Client, l *zap.Logger) *DeleteOutgoingWebhookTool { return &DeleteOutgoingWebhookTool{NewBaseTool(c, l)} }
...
func NewGetPolicyTool(c *client.Client, l *zap.Logger) *GetPolicyTool { return &GetPolicyTool{NewBaseTool(c, l)} }
...
func NewListPoliciesTool(c *client.Client, l *zap.Logger) *ListPoliciesTool { return &ListPoliciesTool{NewBaseTool(c, l)} }
...
func NewCreatePolicyTool(c *client.Client, l *zap.Logger) *CreatePolicyTool { return &CreatePolicyTool{NewBaseTool(c, l)} }
...
func NewUpdatePolicyTool(c *client.Client, l *zap.Logger) *UpdatePolicyTool { return &UpdatePolicyTool{NewBaseTool(c, l)} }
...
func NewDeletePolicyTool(c *client.Client, l *zap.Logger) *DeletePolicyTool { return &DeletePolicyTool{NewBaseTool(c, l)} }
...
func NewGetE2MTool(c *client.Client, l *zap.Logger) *GetE2MTool { return &GetE2MTool{NewBaseTool(c, l)} }
...
func NewListE2MTool(c *client.Client, l *zap.Logger) *ListE2MTool { return &ListE2MTool{NewBaseTool(c, l)} }
...
func NewCreateE2MTool(c *client.Client, l *zap.Logger) *CreateE2MTool { return &CreateE2MTool{NewBaseTool(c, l)} }
...
func NewReplaceE2MTool(c *client.Client, l *zap.Logger) *ReplaceE2MTool { return &ReplaceE2MTool{NewBaseTool(c, l)} }
...
func NewDeleteE2MTool(c *client.Client, l *zap.Logger) *DeleteE2MTool { return &DeleteE2MTool{NewBaseTool(c, l)} }
...
func NewListDataAccessRulesTool(c *client.Client, l *zap.Logger) *ListDataAccessRulesTool { return &ListDataAccessRulesTool{NewBaseTool(c, l)} }
...
func NewCreateDataAccessRuleTool(c *client.Client, l *zap.Logger) *CreateDataAccessRuleTool { return &CreateDataAccessRuleTool{NewBaseTool(c, l)} }
...
func NewDeleteDataAccessRuleTool(c *client.Client, l *zap.Logger) *DeleteDataAccessRuleTool { return &DeleteDataAccessRuleTool{NewBaseTool(c, l)} }
...
func NewListEnrichmentsTool(c *client.Client, l *zap.Logger) *ListEnrichmentsTool { return &ListEnrichmentsTool{NewBaseTool(c, l)} }
...
func NewCreateEnrichmentTool(c *client.Client, l *zap.Logger) *CreateEnrichmentTool { return &CreateEnrichmentTool{NewBaseTool(c, l)} }
...
func NewDeleteEnrichmentTool(c *client.Client, l *zap.Logger) *DeleteEnrichmentTool { return &DeleteEnrichmentTool{NewBaseTool(c, l)} }
...
func NewCreateViewTool(c *client.Client, l *zap.Logger) *CreateViewTool { return &CreateViewTool{NewBaseTool(c, l)} }
...
func NewGetViewTool(c *client.Client, l *zap.Logger) *GetViewTool { return &GetViewTool{NewBaseTool(c, l)} }
...
func NewReplaceViewTool(c *client.Client, l *zap.Logger) *ReplaceViewTool { return &ReplaceViewTool{NewBaseTool(c, l)} }
...
func NewDeleteViewTool(c *client.Client, l *zap.Logger) *DeleteViewTool { return &DeleteViewTool{NewBaseTool(c, l)} }
